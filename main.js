...
function toTitleCase(str) {
    let str1 = str.toLowerCase().split(" "); // i made new variable in which we give argument it will conert it into lower case and split it by space it will be stor in the variable as an array 
    ...
    let str2 = str1.join(" "); //it will join the array by space and convert to string        
    return str2;
}
...
console.log("\nQuestion 9:");
let num1 = 8;
let message2 = "The number " + num1 + " is considered to be a lucky number in Chinese and other Asian cultures.";
...
console.log("\nQuestion 13:");
let my_array = ["bike", "laptop", "watch"];
...
console.log("\nQuestion 14:");
let invitation_to = ["wahaj", "talha", "salik"];
...
console.log("\nQuestion 18:");
let world_tour = ["japan", "switzerland", "turkey", "italy", "germany"];
console.log("original array:", world_tour);
let sorted = world_tour.toSorted();
console.log("sorted array:", sorted);
console.log("original array:", world_tour);
let reversed = world_tour.sort().toReversed();
...
console.log("\nQuestion 22:");
let object1 = { name: "saqlain", age: 23, class: "monday seven to ten"
...
console.log("\nQuestion 23:");
let bike = "kawasaki H2";
let mountain = "Everest";
let laptop = "Dell";
let name = "Saqlain";
let idNumber = 123;
...
console.log("\nQuestion 24:");
let cityInSindh = "Karachi";
let cityInPunjab = "Lahore";
...
;
let list1 = ["pakistan", "india", "japan", "france", "switzerland"];
...
if (alien_color1 == "green") {
    ...
    console.log("you din't make a point");
}
...
console.log("\nQuestion 30:");
let userName = ["admin", "ebad", "amjad", "farjad", "haris"];
...
console.log("\nQuestion 32:");
let current_user = ["EBAD", "Samad", "mubashir", "fouzaib", "Haris"];
let new_user = ["amna", "Ebad", "amjad", "HARIS", "Ubaid"];
let current_lower = current_user.map((i) => {
...
console.log("\nQuestion 34:");
let pizza = ["peproni pizza", "fajita pizza", "tikka pizza"];
...
console.log("\nQuestion 41:");
let magician = ["Derren Brown", "David Copperfield", "Harry Houdini", "Harry Anderson"];
...
let magician1 = ["Derren Brown", "David Copperfield", "Harry Houdini", "Harry Anderson"];
let great1 = make_great2(magician1);
show_magicians(great1);
show_magicians(magician1);
//44.Sandwiches: Write a function that accepts a array of items a person wants on a sandwich. The function should have one parameter that collects as many items as the function call provides, and it should print a summary of the sandwich that is being ordered. Call the function three times, using a different number of arguments each time.
console.log("\nQuestion 44:");
function sandwich(...provide) {
